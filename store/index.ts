...
// SIVERS Disease Library - Predefined search terms
export const siversDiseaseLibrary: DiseaseEntry[] = [
  // Viral Diseases
...
export const useResearchStore = create<ResearchState>()((set, get) => ({
  ...
  currentPage: 1,
  searchQuery: '',
  diseaseLibrary: JSON.parse(localStorage.getItem('diseaseLibrary') || 'null') || siversDiseaseLibrary,
  ...
  return [
    {
      ...
      description: 'Our premium nano silver solution features ultra-small silver nanoparticles (3-5nm) suspended in purified water. Manufactured by American Biotech Labs using proprietary SIVERS technology.',
