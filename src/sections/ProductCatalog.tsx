  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* SilverSol™ Technology Info Block */}
        <Card className="holographic-card mb-8">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-orbitron font-semibold text-lg mb-2 flex items-center gap-2">
                  About SilverSol™ Technology
                </h3>
                <p className="text-muted-foreground text-sm leading-relaxed mb-3">
                  SilverSol™ is an advanced form of nano-structured silver engineered for stability, 
                  safety, and broad-spectrum wellness support. Unlike traditional colloidal silver, 
                  SilverSol™ uses a patented metallic silver particle with a unique oxide coating. 
                  This enhances performance, bio-compatibility, and reliability. SilverSol™ is backed 
                  by extensive research, decades of development, and a strong safety profile.
                </p>
                <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/50 rounded-lg p-3">
                  <Info className="w-4 h-4 text-primary flex-shrink-0" />
                  <span>
                    <strong>Note:</strong> SilverSol™ is not a medical treatment and does not diagnose, 
