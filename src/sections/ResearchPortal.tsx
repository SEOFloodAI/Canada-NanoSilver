...
export function ResearchPortal() {
  ...
  const handleExportCSV = () => {
    ...
    exportToCSV(data, `silversol-research-${searchQuery || selectedDisease?.name || 'search'}-${new Date().toISOString().split('T')[0]}.csv`);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 mb-6">
            ...
            <span className="text-sm font-medium text-primary">SilverSol™ Research Database</span>
          </div>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            ...
            Our research focuses on SilverSol™ Technology applications against pathogens and health conditions.
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-amber-200/90 leading-relaxed">
                  ...
                  SilverSol™ products are sold for research purposes. Always consult a qualified healthcare professional for medical advice.
                </p>
              </div>
            </div>
          </div>
