        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <h1 className="font-orbitron text-3xl sm:text-4xl font-bold mb-4">
              Become a <span className="text-accent">SIVERS</span> Affiliate
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Earn commissions by sharing SIVERS products with your audience. 
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block">Why do you want to promote SIVERS? *</label>
                  <Textarea
                    required
