  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center py-12 px-4">
        ...
        <Card className="holographic-card max-w-md w-full relative z-10">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Thank you for your interest in becoming a SIVERS distributor. 
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <h1 className="font-orbitron text-3xl sm:text-4xl font-bold mb-4">
              Become a <span className="text-primary">SIVERS</span> Distributor
            </h1>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block">Why are you interested in SIVERS? *</label>
                  <Textarea
                    required
              ...
              <Alert className="bg-amber-950/30 border-amber-500/30">
                <AlertDescription className="text-amber-200/90 text-sm">
                  ...
                  and you authorize SIVERS to verify your business credentials. Approved distributors 
